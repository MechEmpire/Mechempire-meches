...
public:
	...
	virtual void gotoFight(RobotAI_Order& order,double,double);
	virtual void gotoCircle(RobotAI_Order& order,const Circle& circle,double);
	virtual void raoStone(RobotAI_Order& order,double,double);
};