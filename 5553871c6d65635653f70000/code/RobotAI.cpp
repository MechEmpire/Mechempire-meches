...
void RobotAI::Update(RobotAI_Order& order, const RobotAI_BattlefieldInformation& info, int myID)
{
	...
	bool isdj = false, isws = false, firstrate_shoot = false, isjq = false, isyf = false,isshu = false,issakura = false,istank = false,ismimi = false,isblue = false;
	//判断是否是坦克
